...
module.exports = function (Promotion) {
    ...
    Promotion.updateLive = (params = {}, cb) => {
        ...
        if (params) {
            ...
            Promotion.upsertWithWhere({ id }, { status, liveDate, liveTime, live: { date, dateStr, time: liveTime, dateNo, month, year, hour, minute } }, (err, res) => {
    ...
    Promotion.remoteMethod('updateLive', {
