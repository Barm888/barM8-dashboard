angular
    .module('app')
    .controller('patronAnalyticsCtl', ['$scope', '$state', '$rootScope', 'Business', '$http', 'VisitCount', 'socket',
        function ($scope, $state, $rootScope, Business, $http, VisitCount, socket) {
            ...
            weekCharts = (arg = []) => {
                ...
                arg.forEach(val => {
                    if (val.dateZero) {
                        ...
                        let { _00to01 = 0, _01to02 = 0, _02to03 = 0, _03to04 = 0, _04to05 = 0, _05to06 = 0,
                            _06to07 = 0, _07to08 = 0, _08to09 = 0, _09to010 = 0, _10to11 = 0, _11to12 = 0
                            , _12to13 = 0, _13to14 = 0, _14to15 = 0, _15to16 = 0, _16to17 = 0, _17to18 = 0,
                            _18to19 = 0, _19to20 = 0, _20to21 = 0, _21to22 = 0, _22to23 = 0, _23to24 = 0 } = val;
                ...
                let array = [_18to23_Age, _24to29_Age, _30to35_Age, _36to41_Age, _42toPlus_Age];

                var Weekmax = array.reduce(function (prev, current) {
                    return (prev.y > current.y) ? prev : current
                })

                if (Weekmax <= 100) { Weekmax = 100; }
                else {
                    Weekmax += 1000;
                }
            ...
            monthCharts = (arg = []) => {
                ...
                for (let i = monthlyStart; i <= monthlyEnd; i++) {
                    if (arg && arg.length == 0) { monthDayArray.push(0); }
                        ...
                        if (val) {
                            let { _00to01 = 0, _01to02 = 0, _02to03 = 0, _03to04 = 0, _04to05 = 0, _05to06 = 0, _06to07 = 0,
                                _07to08 = 0, _08to09 = 0, _09to010 = 0, _10to11 = 0, _11to12 = 0, _12to13 = 0, _13to14 = 0,
                                _14to15 = 0, _15to16 = 0, _16to17 = 0, _17to18 = 0, _18to19 = 0, _19to20 = 0, _20to21 = 0,
                                _21to22 = 0, _22to23 = 0, _23to24 = 0 } = val;
                            let totalCnt = _00to01 + _01to02 + _02to03 + _03to04 + _04to05 + _05to06 + _06to07 + _07to08 + _08to09 + _09to010 + _10to11 + _11to12
                                + _12to13 + _13to14 + _14to15 + _15to16 + _16to17 + _17to18 + _18to19 + _19to20 + _20to21 + _21to22 + _22to23 + _23to24;
            ...
            yearlyChart = (arg = []) => {
                ...
                for (let i = 1; i <= 12; i++) {
                    ...
                    data.forEach(val => {
                        if (val) {
                            let { _00to01 = 0, _01to02 = 0, _02to03 = 0, _03to04 = 0, _04to05 = 0, _05to06 = 0, _06to07 = 0, _07to08 = 0, _08to09 = 0,
                                _09to010 = 0, _10to11 = 0, _11to12 = 0, _12to13 = 0, _13to14 = 0, _14to15 = 0, _15to16 = 0, _16to17 = 0,
                                _17to18 = 0, _18to19 = 0, _19to20 = 0, _20to21 = 0, _21to22 = 0, _22to23 = 0, _23to24 = 0 } = val;
                            let totalCnt = _00to01 + _01to02 + _02to03 + _03to04 + _04to05 + _05to06 + _06to07 + _07to08 + _08to09 + _09to010 + _10to11 + _11to12
                                + _12to13 + _13to14 + _14to15 + _15to16 + _16to17 + _17to18 + _18to19 + _19to20 + _20to21 + _21to22 + _22to23 + _23to24;
