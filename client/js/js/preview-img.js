    ...
    $.fn.uploader = function (options, testMode) {
        ...
        return this.each(function (index) {
            ...
            var dom = {
                ...
                furtherInstructions: $('<p class="js-uploader__further-instructions uploader__further-instructions uploader__hide pull-right"> ' + options.furtherInstructionsCopy + '</p>'),
                save : $('<button class="btn btn-primary" id="whatsImageSave" style="background-color: #4caf50 !important; padding: 5px 10px!important;border-radius: 4px;"><i class="fas fa-cloud-upload-alt"></i> Upload</button>')
            };
            ...
            function setupDOM (dom) {
                ...
                dom.uploaderBox
                    ...
                    .before(dom.furtherInstructions);
            }
            ...
            function bindUIEvents () {
                ...
                dom.save.on('click' , function() {
                   ...
                   $(".js-uploader__contents").removeClass('uploader__hide');
                   $(".uploader__file-list").empty();
                    ...
                    angular.element(document.getElementById('whatsonCtl')).scope().uploadImage(uploadImgArray);
                    renderControls();
                    uploadImgArray = [];
                })
            ...
            function addItem (file) {
                ...
                var removeLink = $('<span class="uploader__file-list__button" style="cursor: pointer;"><button class="uploader__icon-button js-upload-remove-button fa fa-times" data-index="' + id + '"></button></span>');
